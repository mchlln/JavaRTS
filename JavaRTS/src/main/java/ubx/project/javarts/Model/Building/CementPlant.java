...
public class CementPlant extends BuildingDecorator{
    ...
    private static final Map<ResourceType, Integer> dailyProduction = Map.of( CEMENT,4);
    ...
    public BuildingType getType() {
        return BuildingType.CEMENTPLANT;
    }
